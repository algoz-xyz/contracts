...
contract("Algoz", (accounts) => {
    ...
    it("should check if modifier protects update_merkle_root", async () => {
        const instance = await Algoz.deployed();
        await truffleAssert.reverts(
            instance.update_merkle_root("0xaaaaaaae8d3cd97e4d0f42e72f9e277881d9759bebe0d86b0a005f7c7cfcaaaa", { from: accounts[1] }),
            "This function is restricted to the contract's owner"
        );
    });
    ...
    it("should check if update_merkle_root works", async () => {
        ...
        await instance.update_merkle_root(to_update, { from: accounts[0] });
        ...
        await instance.update_merkle_root("0x3454d3ce8d3cd97e4d0f42e72f9e277881d9759bebe0d86b0a005f7c7cfc72a1", { from: accounts[0] });
    });
